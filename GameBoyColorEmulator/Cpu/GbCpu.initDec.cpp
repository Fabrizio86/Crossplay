...
void GbCpu::initDec() {
    ...
    this->opCodes[Instruction::DEC_A] = [this]() {
        ...
        this->flags.halfCarry = ((this->registers.regA & 0x0F) == 0x0F);
    };
    ...
    this->opCodes[Instruction::DEC_HLptr] = [this]() {
        ...
        this->flags.halfCarry = ((value & 0x0F) == 0x0F);
    };
    ...
    this->opCodes[Instruction::DEC_D] = [this]() {
        ...
        this->flags.halfCarry = ((this->registers.regD & 0x0F) == 0x0F);
    };
    ...
    this->opCodes[Instruction::DEC_E] = [this]() {
        ...
        this->flags.halfCarry = ((this->registers.regE & 0x0F) == 0x0F);
    };
    ...
    this->opCodes[Instruction::DEC_H] = [this]() {
        ...
        this->flags.halfCarry = ((this->registers.regH & 0x0F) == 0x0F);
    };
