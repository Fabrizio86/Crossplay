...
void GbCpu::initAdd() {
    ...
    this->opCodes[Instruction::ADD_HL_BC] = [this]() {
        ...
        this->flags.halfCarry = ((hl & 0x07FF) + (bc & 0x07FF)) > 0x07FF;
    ...
    this->opCodes[Instruction::ADD_HL_DE] = [this]() {
        ...
        this->flags.subtract = false;
        this->flags.halfCarry = ((hl & 0x07FF) + (de & 0x07FF)) & 0x0800;
        this->registers.regH = (result >> 8) & 0xFF;
        this->registers.regL = result & 0xFF;
    };
    ...
    this->opCodes[Instruction::ADD_HL_HL] = [this]() {
        ...
        this->flags.carry = ((result & 0x10000) != 0);
        this->flags.subtract = false;
        this->flags.halfCarry = ((hl & 0x07FF) + (hl & 0x07FF)) & 0x0800;
        this->registers.regH = (result >> 8) & 0xFF;
        this->registers.regL = result & 0xFF;
    };
    ...
    this->opCodes[Instruction::ADD_HL_SP] = [this]() {
        ...
        this->flags.carry = (result > 0xFFFF);
        this->flags.subtract = false;
        this->flags.halfCarry = ((hl & 0x07FF) + (sp & 0x07FF) > 0x07FF);
        this->registers.regH = (result >> 8) & 0xFF;
        this->registers.regL = result & 0xFF;
    };
    ...
    this->opCodes[Instruction::ADD_A_n] = [this]() {
        ...
        this->flags.subtract = false;
        this->flags.halfCarry = ((this->registers.regA ^ value ^ temp) & 0x10) != 0;
    ...
    this->opCodes[Instruction::ADC_A_B] = [this]() {
        uint8_t oldRegA = this->registers.regA;
        uint8_t carry = this->flags.carry;
    ...
    this->opCodes[Instruction::ADC_A_n] = [this]() {
        ...
        uint8_t carryValue = this->flags.carry ? 1 : 0;
